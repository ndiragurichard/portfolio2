...
export const siteConfig: SiteConfig = {
  ...
  meta: {
    ...
    defaultDescription: 'Data Analyst skilled in SQL, Power BI, and Python. Passionate about turning data into decisions.',
    keywords: ['Data Analyst', 'SQL', 'Power BI', 'Python', 'Kenya', 'Nairobi', 'Richard Ndirangu', 'Data Analytics'],
    siteUrl: 'https://ndirangu-richard.com',
    locale: 'en',
  },
  ...
  theme: {
    ...
    // - Teal: "180 70% 45%"
    // - Red: "0 80% 50%"
    primaryColor: '220 92% 50%', // Blue - professional for data analytics
  ...
  features: {
    ...
    certifications: true,
    languages: true,
    awards: false, // No awards to display
    smoothScroll: true,
    sideNav: true,
  },
